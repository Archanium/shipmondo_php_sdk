...
class Shipmondo
{
    public const API_ENDPOINT = 'https://app.shipmondo.com/api/public/v3';
    ...
    public function performCall($path, $method = 'GET', $params = [])
    {
        return $this->_makeApiCall($path, $method, $params);
    }

    protected function _makeApiCall($path, $method = 'GET', $params = [])
    {
        $ch = curl_init();
    ...
    protected function _extractPagination($headers)
    {
